...
$col["editoptions"] = array("value"=>":;".$str); 
$col["editoptions"]["onload"]["sql"] = "select amount as k, amount as v from invheader WHERE client_id = '{client_id}'"; 
...
<body>
	...
	{
		// fill dropdown 1 search based on row data
		o = jQuery('.ui-search-toolbar select[name=note]').get();
		o.event = 'onload'; fx_get_dropdown(o,'note',1);		

		// fill dropdown 2 search based on row data
		o = jQuery('.ui-search-toolbar select[name=amount]').get();
		o.event = 'onload'; fx_get_dropdown(o,'amount',1);	
