...
$col["edittype"] = "select";
$col["editable"] = true; // this column is editable
$col["editoptions"] = array("value"=>"100:One Hundred;200:Two Hundred;300:Three Hundred"); // with default display of textbox with size 20
// $col["editrules"] = array("required"=>true); // and is required
$cols[] = $col;
...
$g->select_command = "SELECT i.id, invdate, c.name, note, total FROM invheader i
...
function update_data($data)
{
	...
	{
		$str = $data["params"]["data"];
		mysql_query("UPDATE invheader SET total = '$str'");
		die;
	}
}
