...
class ConfirmOutboundAjaxProcessController extends Controller
{
    //
	public function __construct(CalendarRepository $CalendarRepository,lms_customerdetails $lms_customerdetails,lms_calldetails $lms_calldetails,lms_customerslots $lms_customerslots,lms_slots $lms_slots,lms_timemasters $lms_timemasters,lms_slotrelations $lms_slotrelations,lms_weeks $lms_weeks)
	{
	...
	{
		extract($_REQUEST);
		$selectedScheduleConfirm = $_REQUEST['selectedScheduleConfirm'];
	...
	$actual = $this->CalendarRepository->slotDetailsForAllLeadsUpdate($appdate,$apptime,$zipcode,$lld_CustomerId,$territory_id,$selectedScheduleConfirm);
	if($actual=='success')		
	return 'success';
    else 
