...
data: {"call_statusid" : no_answer,'lld_CustomerId': CustomerId,_token: CSRF_TOKEN},
dataType: "html",
async:false,
...
height:50px;	
	 ...
	 <label class="control-label col-sm-3 col-xs-12"  for="first-name">
        ...
        <form action="Scheduleoutboundscriptflow" method="POST" >	
		  <input type="hidden" name="CustomerId" id="CustomerId" value="{{$customer_details['lcd_CustomerId']}}">
	 ...
	 <div class="form-group">
		...
		<div class="col-md-6 col-sm-5 col-xs-12" id="colmd6">                         
		<select name="lcd_CPTitle" id="no_answer" class="form-control col-md-10" style="float: left;">
