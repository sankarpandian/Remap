...
$("#ProsepctId").text(half_id + territory_code + lld_ProductCode);
 ...
 // $.datepicker._clearDate('datepicker1');
  ...
  var dates = [new Date(2016, 6 - 1, 19), 
             new Date(2016, 7 - 1, 20), 
             new Date(2016, 6 - 1, 21), 
...
/*
  ...
  {!! Form::open(['url' => '/createlead_cusdetails1', 'method' => 'post', 'data-parsley-validate', 'role' => 'form']) !!}    
<input type="hidden" id="lld_CallFromId" name="lld_CallFromId" value="@if(isset($lld_CallFromId)){{$lld_CallFromId}}@endIf" >
<input type="hidden" id="lld_Calldesc" name="lld_Calldesc" value="@if(isset($lld_Calldesc)){{$lld_Calldesc}}@endIf" >
...
<input type="hidden" id="hd_type_id" name="hd_type_id" >
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							  <input type="text" placeholder="First Name" class="form-control" id="lcd_FirstName" name="lcd_FirstName" required  data-parsley-required-message="Please insert your name">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="text" placeholder="Home Phone" class="form-control" id="lcd_HomePhone" name="lcd_HomePhone" required data-parsley-required-message="Please fill Phone Number" >
						</div>
					</div>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                           <textarea class="resizable_textarea form-control" name="lcd_Comments" id="lcd_Comments" placeholder="Comments"></textarea>
					             ...
					             <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">App Date</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <select id="appointment_time" name="appointment_time" class="form-control" required data-parsley-required-message="Please select Appointment Time">
                        
                        </select>
                        </div>
                      </div>
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">App Date/Time</label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <select id="appointment_datetime" name="appointment_datetime" class="form-control" required data-parsley-required-message="Please select Date & Time">
                        <option value="">Select One</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                        <input style="margin:17px 7px;" type="checkbox" id="confirm_lead" name="confirm_lead" value="1">
                        </div>
                      </div>
