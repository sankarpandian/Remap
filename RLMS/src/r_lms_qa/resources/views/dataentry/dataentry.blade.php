...
<div class="x_panel">
 <div class="x_title">
                    <h2>Lead Source Details <small>Without Script</small> <!-- <small>different form elements</small>--></h2>
 ...
 <div class="x_content">
                    ...
                    {!! Form::open(['url' => '/dataentry_cusdetails', 'method' => 'post', 'role' => 'form','id'=>'demo-form2','class'=>'form-horizontal form-label-left','data-parsley-validate']) !!}  
            ...
            @endforeach
					   ...
					   <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Associate ID <span class="required"></span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
