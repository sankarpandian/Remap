...
class OutboundCallerScreenController extends Controller
{
 ...
 public function scheduling_outbound()
 {
    ...
    return view('SchedulingOutbound.OutboundCallerScreen',array('title' => 'Scheduling Outbound', 'description' =>'Scheduling Outbound' , 'page' => 'Scheduling Outbound','get_dashborad_data' => $agent_access,'customer_details'=>$customer_details,'call_status' => $call_status));
